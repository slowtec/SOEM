      ...
      uint16 slave)
{
   ...
   wkc = ecx_mbxreceive(context, slave, pMbxIn, 0);
   ec_clearmbx(pMbxOut);

   return wkc;
}

int ecx_SDOread_send(
      ecx_contextt *context,
      ec_mbxbuft *pMbxIn,
      ec_mbxbuft *pMbxOut,
      uint16 slave,
      ...
      boolean CA)
{
   ...
   wkc = ecx_mbxsend(context, slave, pMbxOut, EC_TIMEOUTTXM);
      ...
      int timeout)
{
   ...
   aSDOp = (ec_SDOt *)pMbxIn;
   SDOp = (ec_SDOt *)pMbxOut;

   /* read slave response */
   wkc = ecx_mbxreceive(context, slave, (ec_mbxbuft *)pMbxIn, timeout);
               ...
               if (Framedatasize < SDOlen) /* transfer in segments? */
               {
                  ...
                  *psize = Framedatasize;
                  ...
                  while (NotLast) /* segmented transfer */
                  {
                     ...
                     wkc = ecx_mbxsend(context, slave, (ec_mbxbuft *)pMbxOut, EC_TIMEOUTTXM);
               ...
               boolean CA, int *psize, void *p, int timeout)
{
   ...
   ecx_SDOread_clear(context, &MbxIn, &MbxOut, slave);

   wkc = ecx_SDOread_send(context, &MbxIn, &MbxOut, slave, index, subindex, CA);
   if (wkc > 0) /* succeeded to place mailbox in slave ? */
   {
      wkc = ecx_SDOread_receive(context, &MbxIn, &MbxOut, slave, index, subindex, psize, p, timeout);
   }
